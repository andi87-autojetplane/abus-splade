...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('balitavisits', function (Blueprint $table) {
            ...
            $table->enum("Campak_rubela_9bulan",["yes","No"]);
            $table->enum("IPV2_9bulan",["yes","No"]);
            $table->enum("PCV3_12bulan",["yes","No"]);
            $table->enum("Campak_rubela_18bulan",["yes","No"]);
            $table->enum("DPT-HB-HIb4_18bulan",["yes","No"]);
            $table->enum("Capak_rubela_lanjutan_kelas1",["yes","No"]);
            $table->enum("DT_kelas1",["yes","No"]);
            $table->enum("Td_kelas2",["yes","No"]);
            $table->enum("Td_kelas5",["yes","No"]);
            $table->enum("HPV_kelas5",["yes","No"]);
            $table->enum("HPV_kelas6",["yes","No"]);

            //Tanda Bahaya balita
            $table->enum("nafas<40_>60",["yes","No"]);
            $table->enum("balita_lemah",["yes","No"]);
            $table->enum("balita_kuning",["yes","No"]);
            $table->enum("tidak_menyusui",["yes","No"]);
            $table->enum("balita_kejang",["yes","No"]);
            $table->enum("suhu>37_5",["yes","No"]);
            $table->enum("balita_diare",["yes","No"]);
            $table->enum("balita_air_seni_kuning_pekat",["yes","No"]);
            $table->enum("balita_tali_pusar_kemerahan",["yes","No"]);
            $table->enum("balita_matacekung",["yes","No"]);
            $table->enum("balita_muntah2",["yes","No"]);
            //Skrining TB
            $table->enum("balita_batuk_terus",["yes","No"]);
            $table->enum("balita_demam>2minggu",["yes","No"]);
            $table->enum("bb_balita_tidaknaik2bulan",["yes","No"]);
            $table->enum("balita_kontak_pasientb",["yes","No"]);
